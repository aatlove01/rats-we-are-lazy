...
if room == rm_night_results
{
	...
	draw_set_font(fnt_Game);
	draw_text(room_width/2, room_height/2, "Food Reserves: " + string(max(reserves + food_gathered + trash_collected, 0)))
...
if room == rm_game_over
{
	...
	draw_set_halign(fa_center);
	draw_set_font(fnt_Game);
	draw_text(room_width/2, room_height/2, "Nights Survived: " + string(nights_survived))
}